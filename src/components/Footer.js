...
const Footer = (props) => {
  ...
  return (
    <Grid margin="100px 0 0">
      <Grid width="100%" height="250px" margin="auto" bg="#121212">
        <Image src={f} height="250px" />
      </Grid>
      <Grid height="280px">
          ...
          <Grid margin="0px 20px 0px 0px" height="280px">
            ...
            <Text size="16px" margin=" 20px 0" color="rgb(105, 105, 105)">
                <a
                    ...
                    onClick={() => {
                      document.location.href = "/ClassRegister";
                    }}
                >
                클래스 신청하기
              </a>
